...
const IResidenceLanding: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #ffffff 0%, #f0fdf4 30%, #ecfdf5 60%, #f6fff9 100%)",
      }}
    >
      {/* ---------- NAVBAR ---------- */}
      <header className="fixed top-0 left-0 w-full bg-white/90 backdrop-blur-lg z-50 border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-5">
          ...
          <Link
            ...
            className="hidden md:inline-block px-6 py-2.5 bg-gradient-to-r from-[#1ba89a] to-[#16968a] text-white rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
            Launch App
          </Link>
      ...
      >
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
            ...
            from one app.
            <br />
            <span className="font-semibold text-[#1ba89a]">Experience the high standard of i-Residence today.</span>
          </p>
        </motion.div>

        <div className="hidden md:block w-px h-48 bg-gradient-to-b from-transparent via-[#1ba89a] to-transparent"></div>

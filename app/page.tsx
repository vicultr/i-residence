        ...
        >
          {slides.map((slide, index) => (
            ...
            >
              ...
              {/* Text & CTA */}
              <div className="relative z-20 max-w-2xl px-6 md:px-16 py-16 md:py-48 text-center md:text-left">
                ...
                <div className="flex flex-col gap-4 sm:flex-row justify-center md:justify-start">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-6 py-3 border-2 border-[#1ba89a] text-[#1a3d4d] rounded-full font-semibold text-lg hover:bg-[#1ba89a]/10 transition text-center"
                  >
                    {slide.cta2}
                  </a>
                </div>
